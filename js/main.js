...
let gasoline = document.getElementById("gasoline");
...
diesel.addEventListener("click", function() {
    document.querySelectorAll(".fa-circle").forEach((circle) => {
        ...
        document.querySelector(".circle-one").classList.add("colored");
        console.log("zzz");
    });
    searchDiesel();
...
gasoline.addEventListener("click", function() {
    document.querySelectorAll(".fa-circle").forEach((circle) => {
        circle.classList.remove("colored");
        document.querySelector(".circle-one").classList.add("colored");
        console.log("zzz");
...
//     document.querySelectorAll(".fa-circle").forEach(circle => {
//         circle.classList.remove("colored");
//         document.querySelector("#myDropdown2.circle-one").classList.add("colored");
//         console.log("zzz")
//     })
//     searchCheep();
//     document.getElementById("con-test").classList.add("ree");
...
//         affordable.firstChild.classList.add("colored");
//         // document.querySelector("#myDropdown2 .circle-tow").classList.add("colored");
//         console.log("hh")
//     })
//     searchAffordable();
//     document.getElementById("con-test").classList.add("ree");
...
// expinsive.addEventListener("click", function() {
//     document.querySelectorAll(".fa-circle").forEach(circle => {
//         circle.classList.remove("colored");
//         document.querySelector("#myDropdown2.circle-there").classList.add("colored");
//         console.log("hh")
//     })
//     searchExpinsive();
//     document.getElementById("con-test").classList.add("ree");
...
document.getElementById("bmw").addEventListener("click", function() {
    document.querySelectorAll(".fa-circle").forEach((circle) => {
        circle.classList.remove("colored");
        document.querySelector(".circle-two").classList.add("colored");
    });
    searchCar("bmw");
    console.log("mmm");
    document.getElementById("con-test").classList.add("ree");
...
document.getElementById("tesla").addEventListener("click", function() {
    document.querySelectorAll(".fa-circle").forEach((circle) => {
        circle.classList.remove("colored");
        document.querySelector(".circle-three").classList.add("colored");
    });
    searchCar("tesla");
    document.getElementById("con-test").classList.add("ree");
    closeSideBar();
...
document.getElementById("jeep").addEventListener("click", function() {
    document.querySelectorAll(".fa-circle").forEach((circle) => {
        circle.classList.remove("colored");
        document.querySelector(".circle-four").classList.add("colored");
    });
    searchCar("jeep");
    document.getElementById("con-test").classList.add("ree");
    closeSideBar();
...
// function searchCheep() {
//     let searchChee = arr.filter((car) => car.cost <= 40000);
//     updateList(searchChee);
//     console.log("fgfg");
// }

// function searchAffordable() {
//     let searchAff = arr.filter((car) => car.cost > 40000 && car.cost <= 80000);
//     updateList(searchAff);
//     console.log("wwww");
// }

// function searchExpinsive() {
//     let searchExp = arr.filter((car) => car.cost > 80000);
//     updateList(searchExp);
//     console.log("rrr");
// }
...
const priceListFilter = (type) => {
    ...
    // let search;
    // if (type === "cheep") {
    //     search = arr.filter(car => car.cost <= 40000)
    // } else if (type === "affordable") {
    //     search = arr.filter(car => car.cost > 40000 && car.cost <= 80000)
    // } else {
    //     search = arr.filter(car => car.cost > 80000)
    // }
    ...
    // arr.filter((car) => condation)
};

function searchDiesel() {
    let searchDie = arr.filter((car) => car.disciption.includes("diesel"));
    updateList(searchDie);
}

function searchElectricity() {
    let searchElec = arr.filter((car) => car.disciption.includes("electric"));
    updateList(searchElec);
}

function searchGasoline() {
    let searchGas = arr.filter((car) => car.disciption.includes("gasoline"));
    updateList(searchGas);
}